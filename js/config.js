...
FR.Shop = {
    ...
    cosmetics: {
        ...
        // ---- Nature & Animals ----
        wolfpack:    { name: 'Wolf Pack',      cost: 110, owned: false, jacket: 0x7a7a88, scarf: 0xaaaabb, hat: 0x5a5a66 },
        foxden:      { name: 'Fox Den',        cost: 100, owned: false, jacket: 0xcc7722, scarf: 0xffaa44, hat: 0xaa5500 },
        bearclaw:    { name: 'Bear Claw',      cost: 120, owned: false, jacket: 0x6a4422, scarf: 0x8a6644, hat: 0x4a2a0a },
        eaglesoar:   { name: 'Eagle Soar',     cost: 130, owned: false, jacket: 0x3a2a1a, scarf: 0xdaa520, hat: 0x2a1a0a },
        stag:        { name: 'Stag',           cost: 100, owned: false, jacket: 0x7a5a3a, scarf: 0xc8a878, hat: 0x5a3a1a },
        panther:     { name: 'Panther',        cost: 150, owned: false, jacket: 0x1a1a1e, scarf: 0x3a3a44, hat: 0x0e0e12 },
        flamingowild:{ name: 'Wild Flamingo',  cost: 110, owned: false, jacket: 0xff3388, scarf: 0xff77aa, hat: 0xdd1166 },
        treefrog:    { name: 'Tree Frog',      cost: 90,  owned: false, jacket: 0x33bb22, scarf: 0x77dd44, hat: 0x229911 },
        hawkeye:     { name: 'Hawk Eye',       cost: 120, owned: false, jacket: 0x6a4a2a, scarf: 0xccaa44, hat: 0x4a2a0a },
        salmon:      { name: 'Salmon Run',     cost: 100, owned: false, jacket: 0xee7766, scarf: 0xffaa99, hat: 0xcc5544 },
    },
    ...
    icons: {
        ...
        otter:       { name: 'Otter',       icon: '\u{1F9A6}', bg: '#6a8a7a', rarity: 'common', owned: false },
        sloth:       { name: 'Sloth',       icon: '\u{1F9A5}', bg: '#8a7a5a', rarity: 'common', owned: false },
        beaver:      { name: 'Beaver',      icon: '\u{1F9AB}', bg: '#7a5a3a', rarity: 'common', owned: false },
        // ---- Uncommon (16) ----
        ...
        gorilla:     { name: 'Gorilla',     icon: '\u{1F98D}', bg: '#4a4a5a', rarity: 'uncommon', owned: false },
        shark:       { name: 'Shark',       icon: '\u{1F988}', bg: '#4a6a8a', rarity: 'uncommon', owned: false },
        mammoth:     { name: 'Mammoth',     icon: '\u{1F9A3}', bg: '#7a6a5a', rarity: 'uncommon', owned: false },
        // ---- Rare (12) ----
        ...
        baldeagle:   { name: 'Bald Eagle',  icon: '\u{1FABD}', bg: '#5a4a3a', rarity: 'rare', owned: false },
        alphawolf:   { name: 'Alpha Wolf',  icon: '\u{1F43A}', bg: '#5a6a7a', rarity: 'rare', owned: false },
        // ---- Epic (7) ----
        ...
        dodo:        { name: 'Dodo',        icon: '\u{1F9A4}', bg: '#8a7a6a', rarity: 'epic', owned: false },
        // ---- Legendary (3) ----
        ...
        trex:        { name: 'T-Rex',       icon: '\u{1F995}', bg: '#5a8a3a', rarity: 'legendary', owned: false },
    },
    activeIcon: null,
    CRATE_COST: 500,
...
FR.Trails = {
    types: {
        ...
        pollen:   { name: 'Pollen',   color: 0xffdd44, color2: 0xffee88, owned: false, icon: '\uD83C\uDF3C' },
        moss2:    { name: 'Moss',     color: 0x447733, color2: 0x77aa55, owned: false, icon: '\uD83C\uDF3F' },
        feather:  { name: 'Feather',  color: 0xddccbb, color2: 0xffeedd, owned: false, icon: '\uD83E\uDEB6' },
        bloodmoon:{ name: 'Blood Moon',color: 0xaa0022, color2: 0xff2244, owned: false, icon: '\uD83C\uDF15' },
        aurora:   { name: 'Aurora',   color: 0x22ddaa, color2: 0x44ffcc, owned: false, icon: '\uD83E\uDD8B' },
        venom:    { name: 'Venom',    color: 0x8833aa, color2: 0xbb66dd, owned: false, icon: '\uD83D\uDC0D' },
        petal:    { name: 'Petal',    color: 0xff88aa, color2: 0xffbbcc, owned: false, icon: '\uD83C\uDF37' },
        swamp:    { name: 'Swamp',    color: 0x445522, color2: 0x667744, owned: false, icon: '\uD83D\uDC0A' },
        honey:    { name: 'Honey',    color: 0xffaa22, color2: 0xffcc66, owned: false, icon: '\uD83C\uDF6F' },
        tundra:   { name: 'Tundra',   color: 0x88aabb, color2: 0xbbddee, owned: false, icon: '\uD83D\uDC3A' },
    },
    active: 'none',
    cost: 300,
    CRATE_COST: 1000
